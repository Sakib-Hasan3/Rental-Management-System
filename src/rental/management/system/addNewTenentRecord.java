...
public class addNewTenentRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 870, 150, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 880, 150, -1));

        jLabel12.setFont(new java.awt.Font("Cambria", 1, 60)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 153, 153));
        jLabel12.setText("ADD NEW TENENT DETAILS");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 20, 820, 60));
...
// code for save button 
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            st.executeUpdate("insert into tenent values('" + flatno + "','" + name + "','" + gender + "','" + no_of_family + "','" + contact_no + "','" + address + "','" + nid_no + "','" + passport_no + "','" + months_started + "');");
