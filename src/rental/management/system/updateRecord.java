...
public class updateRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 880, 180, -1));

        jButton1.setFont(new java.awt.Font("Cambria", 1, 36)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rental/management/system/Close.png"))); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 880, 180, -1));

        jButton3.setFont(new java.awt.Font("Cambria", 1, 36)); // NOI18N
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rental/management/system/search.png"))); // NOI18N
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 10, 570, 90));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rental/management/system/rsz_11interior-has-armchair-empty-white-wall.jpg"))); // NOI18N
        jLabel10.setText("jLabel10");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -80, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       String flatno = jTextField1.getText();
        ...
        String nid_no = jTextField6.getText();
        String passport_no = jTextField7.getText();
        String months_started = jTextField8.getText();
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeUpdate("update tenent set name='" + name + "',gender='" + gender + "',no_of_members='" + no_of_family + "',contact_no='" + contact_no + "',address='" + address + "',nid_no='" + nid_no + "',passport_no='" + passport_no + "',months_started='" + months_started + "' where flatno='"+flatno+"';");
