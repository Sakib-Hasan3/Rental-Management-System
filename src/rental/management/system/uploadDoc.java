...
public class uploadDoc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rental/management/system/select.jpeg"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rental/management/system/select.jpeg"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rental/management/system/select.jpeg"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rental/management/system/rsz_11interior-has-armchair-empty-white-wall.jpg"))); // NOI18N
      ...
      //  image2=image2.replace("\\","\\\\");
       int dno=1; 
        ...
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.execute("insert into document(photo,nid_card,police_verification,flatno) values('" + image + "','" + image1 + "','" + image2 + "','" +flatno+ "');");
